...
[About][about] · [Blog][blog] · [RSS][rss] · [WeChat][qrcode]
...
**[cpp-linter-action][cpp-linter-action]** [![stars](https://img.shields.io/github/stars/cpp-linter/cpp-linter-action?style=social&label=)][cpp-linter-action]<br>
clang-format and clang-tidy on every pull request, posted back as inline review comments.

**[Conventional Branch][conventional-branch]** [![stars](https://img.shields.io/github/stars/conventional-branch/conventional-branch?style=social&label=)][conventional-branch]<br>
...
**[commit-check][commit-check]** [![stars](https://img.shields.io/github/stars/commit-check/commit-check?style=social&label=)][commit-check]<br>
Enforce commit message, branch naming, and AI-attribution rules — in CI or as a pre-commit hook.

**[Open Delivery Spec][ods]** — what I'm building now<br>
