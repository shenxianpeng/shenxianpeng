...
| Workflows & insights | Platform tooling, API integrations, and maturity metrics for engineering teams. | 🔗 [atlassian-api-py][atlassian-api-py] · 📊 [gitstats][gitstats] · 📈 [devops-maturity][devops-maturity] |
...
- [AI Agent, or Automation?](https://shenxianpeng.github.io/en/posts/2026/ai-agents-vs-automations/) - Apr 20, 2026<!-- BLOG-POST-LIST:END -->
